...
create table UUSER(
  ...
  constraint uuser_wallet_FK FOREIGN KEY(wallet_id) REFERENCES WALLET(wallet_id), --Ǯ��id���
  constraint UUSER_ROLE_FK FOREIGN KEY(role_id) REFERENCES ROLE(role_id) --��ɫid���
);
...
insert into UUSER values(USER_NEXTID_SQ.NEXTVAL,'seller','12345','��','tes1t@qq.com','13800138',3,4);
select * from UUSER;
...
--brand
create table BRAND(
  brand_id number(20) constraint pk_brand_id primary key,  --Ʒ��ID
...
create table ORDER_ITEM(
  order_id number(20) constraint pk_order_id primary key,       --����ID
  pro_id number(20),   --��ƷID
  pro_id_count number(20),  --��Ʒ����
  man_id number(20),    --������ID
  seller_id number(20), --������ID
  state varchar2(20)    --����״̬
);
