...
public class UserController {
	...
	//取得用户被授予的模块与功能
	@RequestMapping(value="/get/grandModlesAndFunctions",method= {RequestMethod.GET})
	public List<ModuleModel> getGrandModlesAndFunctions(int id) throws Exception{
		return userService.getGrandModulesAndFunctions(id);
	};
}
