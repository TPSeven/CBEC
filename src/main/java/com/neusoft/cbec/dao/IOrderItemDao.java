...
public interface IOrderItemDao {
  ...
  //修
   ...
   //根据检索条件取得订单的列表 ,无分页
    ...
    //根据检索条件取得订单的个数
    public int selectCountByCondition(@Param("order_id")int order_id,@Param("man_id")int man_id,@Param("startDate")Date startDate,@Param("endDate")Date endDate,@Param("man_name")String man_name) throws Exception;
