...
public interface IOrderItemDao {
  ...
  //根据检索条件取得订单的个数
    public int selectCountByMan(@Param("man_id")int man_id) throws Exception;
   ...
   //订单个数
    ...
    //取得指定制造商的订单列表,无分页
    public List<OrderItemModel>  selectListByManufacturerWithPage(@Param("man_id")int man_id,@Param("start")int start,@Param("end")int end)throws Exception;
    //验证登陆
